// lib/widgets/quiz_widgets/images_matching_quiz_logic_new.dart
import 'dart:async';
import 'dart:math';
...
class ImagesMatchingQuizLogicNew extends ChangeNotifier {
  ...
  void _startNewQuiz() {
    if (initialNouns.isEmpty) {
      debugPrint('ImagesMatchingQuizLogicNew: initialNouns is empty.');
      return;
    }
